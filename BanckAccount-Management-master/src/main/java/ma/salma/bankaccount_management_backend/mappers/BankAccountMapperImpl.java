//Convertit :(Entity → DTO) et (DTO → Entity)et cela évite d’exposer directement les entités JPA via l’API.
package ma.salma.bankaccount_management_backend.mappers;
